...
import { QuestionBankService } from "../../../../services/banks/content/question.service.ts/QuestionBank.service";

class QuestionBankController {
  // Create question Bank
  createQuestionBank = asyncHandler(async (req: Request, res: Response) => {
    const result = await QuestionBankService.createQuestionBank(req.body);
  ...
  getQuestionsBankByContentId = asyncHandler(async (req: Request, res: Response) => {
    const questionsBank = await QuestionBankService.getQuestionsBankByContentId(
